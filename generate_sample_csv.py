...
# Define the full set of 12 exercises requested by the user, including details, print names, and IDs
data = [
    {
        "ID": "1",
        ...
        "Form_Instruction_2": "Span je billen aan en duw je heupen omhoog tot je lichaam een rechte lijn vormt van schouders tot knieën.",
    ...
    },
    {
        ...
        "Form_Instruction_3": "Loop vooruit met rustige, gecontroleerde stappen terwijl je je lichaam perfect recht houdt.",
    ...
    },
    {
        ...
        "Form_Instruction_3": "Laat je borst zakken tot tussen de kettlebell-handvatten, houd je onderarmen verticaal.",
    ...
    },
    {
        ...
        "Form_Instruction_3": "Huid je schouders perfect horizontaal en span je core aan om te voorkomen dat je lichaam zijwaarts kantelt.",
...
def main():
    ...
    print("Successfully generated workout_data.csv with all 12 exercises.")
